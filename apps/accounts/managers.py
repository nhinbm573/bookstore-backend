...
class AccountManager(BaseUserManager):
    ...
    def create_user(self, email, phone=None, full_name=None, birthday=None,
        ...
        return self._create_user(email, phone, full_name, birthday, password, **extra_fields)

    def create_superuser(self, email, phone=None, full_name=None, birthday=None,
                         password=None, **extra_fields):
